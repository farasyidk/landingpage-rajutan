            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url("admin/about");?>"><span class="glyphicon glyphicon-th"></span></i> About</a>
                        </li>

                        <li>
                            <a href="<?php echo base_url("admin/feature");?>"><span class="glyphicon glyphicon-th"></span></i> Services</a>
                        </li>


                        <li>
                            <a href="<?php echo base_url("admin/table");?>"><i class="fa fa-table fa-fw"></i> Produk</a>
                        </li>
                        <li>
